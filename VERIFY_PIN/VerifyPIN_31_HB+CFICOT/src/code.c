...
#include "commons.h"
#include "CFICOT.h"
#include "VERIFY_PIN/VerifyPIN_31_HB+CFICOT/src/code.cfi.h"
 ...
 * version 31 with CFI enabled and without conditionnal execution of byteArrayCompare
 */
#undef CFI_FUNC
#define CFI_FUNC verifyPIN_31
#if defined INLINE && defined PTC
inline uint16_t verifyPIN_31(volatile BOOL *result) __attribute__((always_inline))
#else
